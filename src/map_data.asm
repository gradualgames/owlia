...
.scope piratetavern_data
.include "piratetavern.inc"
.endscope

piratetavern_metatile_table_properties = piratetavern_data::metatile_table_properties
piratetavern_metatile_table_params = piratetavern_data::metatile_table_params
piratetavern_metatile_table_attributes = piratetavern_data::metatile_table_attributes
piratetavern_metatile_table_top_left_tiles = piratetavern_data::metatile_table_top_left_tiles
piratetavern_metatile_table_top_right_tiles = piratetavern_data::metatile_table_top_right_tiles
piratetavern_metatile_table_bottom_left_tiles = piratetavern_data::metatile_table_bottom_left_tiles
piratetavern_metatile_table_bottom_right_tiles = piratetavern_data::metatile_table_bottom_right_tiles
piratetavern_big_metatile_table_top_left = piratetavern_data::big_metatile_table_top_left
piratetavern_big_metatile_table_top_right = piratetavern_data::big_metatile_table_top_right
piratetavern_big_metatile_table_bottom_left = piratetavern_data::big_metatile_table_bottom_left
piratetavern_big_metatile_table_bottom_right = piratetavern_data::big_metatile_table_bottom_right
piratetavern_map = piratetavern_data::map