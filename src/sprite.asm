...
next_shadow_spot:
  ...
  sbc camera_x
  sta shadow_spot_screen_x_lo,x
  lda shadow_spot_x_hi,x
  sbc camera_x+1
  bne cull_shadow_spot
  sta shadow_spot_screen_x_hi,x

  sec
  lda shadow_spot_y_lo,x
  sbc camera_y
  sta shadow_spot_screen_y_lo,x
  lda shadow_spot_y_hi,x
  sbc camera_y+1
  sta shadow_spot_screen_y_hi,x
  ...
  clc
  lda shadow_spot_screen_y_lo,x
  adc #CAMERA_SCREEN_ORIGIN_Y
  sta shadow_spot_screen_y_lo,x
  lda shadow_spot_screen_y_hi,x
  adc #$00
  bne cull_shadow_spot
  sta shadow_spot_screen_y_hi,x
...
cull_shadow_spot:
  ...
  ;zero out shadow spot's screen coordinates so we never draw it again
  lda #$00
  sta shadow_spot_screen_x_lo,x
  sta shadow_spot_screen_x_hi,x
  sta shadow_spot_screen_y_lo,x
