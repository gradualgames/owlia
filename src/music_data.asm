...
Square2:
  ...
  .byte AS2,STL,30,AS2,DS3,D3,STL,50,C3,STL,10,D3,STL,30,G3,F3,STL,20,DS3,STL,10,AS2,AS2,C3
  .byte D3,STL,30,DS3,F3,STL,10,G3,GS3,G3,F3,G3,D3,STL,30,G3,F3,STL,20,DS3,STL,10,AS2,STL
  .byte 30,AS2,DS3,D3,C3,AS2,A2,CS3
  .byte GOT
  .word Square2
