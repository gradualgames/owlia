...
;****************************************************************
.define locations \
    village_house1_entrance_location, \
    village_inn_entrance_location, \
    village_weaponstore_entrance_location, \
    village_potionstore_entrance_location, \
    village_housebl_entrance_location, \
    village_housebr_entrance_location, \
    village_housetr_entrance_location, \
    village_bottom_entrance_location, \
    house1_exit_location, \
    inn_exit_location, \
    weaponstore_exit_location, \
    potionstore_exit_location, \
    housebl_exit_location, \
    housebr_exit_location, \
    housetr_exit_location, \
    overworld_top_entrance_location, \
    overworld_dungeon_entrance_location, \
    dungeon_start_location, \
